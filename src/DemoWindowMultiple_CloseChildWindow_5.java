...
public class DemoWindowMultiple_CloseChildWindow_5 {

	public static void main(String[] args) throws InterruptedException {
		// TODO Auto-generated method stub
		// program to get Title for  the Parent Window and Close the child window.
		...
		// Designed to close the Child  window handle and get only the Parent window title
		for(String w:whs)
		{
			...
			if(pwh.equals(w))
			{
				...
				System.out.println("The title of the Parent Page : "+ title);
